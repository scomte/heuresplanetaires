...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowIcon(QIcon('images/heuresplanetaires.png'))
    ...
    def updateHoursDisplay(self):
        ...
        astrology.location = self.lELocation.text().title()
        ...
        if ((self.location != self.lELocation.text()) or self.init):
            if not self.init:
                with open(self.locationFilePath, "w") as f:
                    ...
                    f.write(self.lELocation.text().title())
                    f.close()
            locationDatas = get_location_datas(self.lELocation.text())
            errorLocation = locationDatas["error"]
            self.lELocation.setText(self.lELocation.text().title())
            self.location = self.lELocation.text().title()
